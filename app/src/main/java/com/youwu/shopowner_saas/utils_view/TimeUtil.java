...
public class TimeUtil {
    ...
    public static String getStart(String startTime) {
        Date date1 = TimeUtils.string2Date(startTime, "yyyy.MM.dd");
        return date1.getTime() / 1000 + "";
    }

    public static String getEnd(String endTime) {
     ...
     * @return
     */
    public static String getFrontDay(String time, int i) {
        Date date= strToDate(time);
        Calendar cal=new GregorianCalendar();
        cal.setTime(date);
        cal.set(Calendar.DATE, cal.get(Calendar.DATE)-i);
        return dateFormats(cal.getTime());
    }
