...
public class ArcProgressBar extends View {
     ...
     * 圆弧的宽度
     */
    private int mStrokeWidth = dp2px(18);
    /**
     * 圆弧开始的角度
     */
     ...
     * 起点角度和终点角度对应的夹角大小
     */
    private float mAngleSize = 220;
    /**
     * 圆弧背景颜色
     */
    private int mArcBgColor = 0xFFE8E8E8;
    /**
     * 最大的进度，用于计算进度与夹角的比例
     */
     ...
     * 进度圆弧的颜色
     */
    private int mProgressColor = 0xFF2196FF;
    /**
     * 第一行文本
     */
    private String mFirstText = "昨日超越";
    /**
     * 第一行文本的颜色
     */
     ...
     * 第一行文本的字体大小
     */
    private float mFirstTextSize = 21f;
    /**
     * 第二行文本
     */
     ...
     * 第二行文本的颜色
     */
    private int mSecondTextColor = Color.BLACK;
    /**
     * 第二行文本的字体大小
     */
    private float mSecondTextSize = 50f;


    /**
     * 第三行文本
     */
    private String mThreeText = "店铺";
    /**
     * 第三行文本的颜色
     */
    private int mThreeTextColor = Color.BLACK;
    /**
     * 第三行文本的字体大小
     */
    private float mThreeTextSize = 21f;
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mThreeText = array.getString(R.styleable.ArcProgressBar_arc_three_text);
        mThreeTextSize = dp2px(array.getDimension(R.styleable.ArcProgressBar_arc_three_text_size, 20f));
        mThreeTextColor = array.getColor(R.styleable.ArcProgressBar_arc_three_text_color, Color.RED);

        mAngleSize = array.getFloat(R.styleable.ArcProgressBar_arc_angle_size, 220);
        mStartAngle = array.getFloat(R.styleable.ArcProgressBar_arc_start_angle, 160f);
        array.recycle();
    }
    ...
    private void drawFirstText(Canvas canvas, float centerX) {
        ...
        canvas.drawText(mFirstText, centerX, firstTextBounds.height() / 2 + getHeight() * 1 / 4, paint);
    }
    ...
    private void drawSecondText(Canvas canvas, float centerX) {
        ...
        canvas.drawText(mSecondText, centerX, getHeight() / 2 + bounds.height() / 5, paint);
    }
     ...
     * @param centerX 文本
     */
    private void drawThreeText(Canvas canvas, float centerX) {
        Paint paint = new Paint();
        paint.setAntiAlias(true);
        paint.setColor(mThreeTextColor);
        paint.setTextAlign(Paint.Align.CENTER);
        paint.setTextSize(mThreeTextSize);
        Rect bounds = new Rect();
        paint.getTextBounds(mThreeText, 0, mThreeText.length(), bounds);
        canvas.drawText(mThreeText, centerX, getHeight() / 2 + bounds.height() / 2 +
                getFontHeight(mThreeText, mSecondTextSize), paint);
    }
