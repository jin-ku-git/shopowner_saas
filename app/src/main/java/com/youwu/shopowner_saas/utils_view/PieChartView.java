...
//        radius = Math.min(width, height) / 3;
        radius =(int) (Math.min(width, height) / 2.8); ;
    ...
    public static class ItemType {
        ...
        public ItemType(String type, int widget, int color,String frequency,String total_money) {
            this.type = type;//公司名称
            this.widget = widget;//占比
            this.color = color;//颜色
            this.frequency = frequency;//共多少笔
            this.total_money = total_money;//共多少元
        }
...
//        }
        public String getPercent() {
            if (frequency==null||"".equals(frequency)){
                return "共"+total_money+"元";
            }else {
                return "共"+total_money+"人";
            }
