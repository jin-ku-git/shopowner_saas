...
//    public static String baseUrl = "https://saasapi.youwuu.com/app/";//正式 20023-02-2
    ...
    private RetrofitClient(String url, Map<String, String> headers) {
        ...
        if (httpCacheDirectory == null) {
            httpCacheDirectory = new File(mContext.getCacheDir(), "youwu_shopowner_saas");
        }
...
//                .cache(cache)
                ...
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        KLog.i("header type:"+type);
                        if (type!=0){
                            builder.header("Authorization", UserUtils.getTokenType() +" "+UserUtils.getToken());
                        }
                        type++;
