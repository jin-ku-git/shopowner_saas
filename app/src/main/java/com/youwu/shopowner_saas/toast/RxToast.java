...
public class RxToast {
    ...
    public static void pink(@NonNull String message) {
        pink(getContext(), message, Toast.LENGTH_LONG, true).show();
    }
    ...
    public static void showTipToast(Activity activity, String message) {
        TipDialog tipDialog = new TipDialog(activity, message);
