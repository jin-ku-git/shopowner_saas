...
import com.youwu.shopowner_saas.databinding.ActivityChongZhiBinding;
 ...
 * 2023/03/07
 */
public class ChongZhiActivity extends BaseActivity<ActivityChongZhiBinding, ChongZhiViewModel> {
    ...
    @Override
    public ChongZhiViewModel initViewModel() {
        //使用自定义的ViewModelFactory来创建ViewModel，如果不重写该方法，则默认会调用LoginViewModel(@NonNull Application application)构造方法
        AppViewModelFactory factory = AppViewModelFactory.getInstance(getApplication());
        return ViewModelProviders.of(this, factory).get(ChongZhiViewModel.class);
    }
