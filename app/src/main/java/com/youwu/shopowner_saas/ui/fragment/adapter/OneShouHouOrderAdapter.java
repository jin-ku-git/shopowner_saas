 ...
 * 订单适配器
 */
public class OneShouHouOrderAdapter extends RecyclerView.Adapter<OneShouHouOrderAdapter.myViewHodler> {
    ...
    //创建构造函数
    public OneShouHouOrderAdapter(Context context, List<OrderBean> goodsEntityList, int type) {
        //将传递过来的数据，赋值给本地变量
...
//        }
        ...
        if (mList.get(position).getOrder_refund()!=null){
            holder.ShouHouLayout.setVisibility(View.VISIBLE);
            ...
            holder.ShouHouLayout.setVisibility(View.GONE);
        }
