 ...
 * @date: 2023/03/08
 */
public class GoodsSetTowUpActivity extends BaseActivity<ActivityGoodsSetUpTowBinding, GoodsSetUpViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_goods_set_up_tow;
    }
    ...
    public void initViewObservable() {
        ...
        viewModel.IntegerEvent.observe(this, new Observer<Integer>() {
            ...
            public void onChanged(Integer integer) {
                switch (integer){
                    case 1:
                        RxToast.showTipToast(GoodsSetTowUpActivity.this,"修改成功！");
...
//                viewModel.getGoodsGroup(store_id,page+"",limit+"");
    ...
    public void initData() {
        ...
        viewModel.YXJ_num.set(0);
        viewModel.SQ_num.set(0);
...
//        CabinetEntityList.addAll(goodsDao.getGoodListByGroupId(goods_id));
    ...
    private void TipsToast(String content,CommunityBean date, int type){
        new  XPopup.Builder(GoodsSetTowUpActivity.this)
