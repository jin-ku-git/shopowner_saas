...
import com.youwu.shopowner_saas.databinding.ActivityBatchOperationBinding;
...
import com.youwu.shopowner_saas.ui.goods_operate.adapter.BatchOperationRightAdapter;
 ...
 * @date: 2023/03/11
 */
public class BatchOperationActivity extends BaseActivity<ActivityBatchOperationBinding, BatchOperationViewModel> {
    ...
    //商品recyclerveiw的适配器
    private BatchOperationRightAdapter mCabinetListRecycleAdapter;
    ...
    @Override
    public BatchOperationViewModel initViewModel() {
        //使用自定义的ViewModelFactory来创建ViewModel，如果不重写该方法，则默认会调用LoginViewModel(@NonNull Application application)构造方法
        AppViewModelFactory factory = AppViewModelFactory.getInstance(getApplication());
        return ViewModelProviders.of(this, factory).get(BatchOperationViewModel.class);
    }
    ...
    public void initViewObservable() {
        ...
        viewModel.IntegerEvent.observe(this, new Observer<Integer>() {
            ...
            public void onChanged(Integer integer) {
                switch (integer){
                    case 1:
                        RxToast.showTipToast(BatchOperationActivity.this,"修改成功！");
                    ...
                    case 2://全选
                        ...
                        binding.yesCheck.setChecked(!binding.yesCheck.isChecked());
...
//                viewModel.getGoodsGroup(store_id,page+"",limit+"");
    ...
    public void initData() {
        ...
        binding.yesCheck.setOnCheckedChangeListener(new SmoothCheckBox.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(SmoothCheckBox checkBox, boolean isChecked) {


                for (int i=0;i<CabinetEntityList.size();i++){
                    CabinetEntityList.get(i).setSelect(binding.yesCheck.isChecked());
                }
...
//                CabinetEntityList.addAll(goodsDao.getGoodListByGroupId(groupBean.getId()));
                ...
                binding.yesCheck.setChecked(false);

                for (int i=0;i<10;i++){
                    CommunityBean communityBean=new CommunityBean();
                    communityBean.setGoods_name(groupBean.getName()+i);
...
//        CabinetEntityList.addAll(goodsDao.getGoodListByGroupId(goods_id));
        ...
        for (int i=0;i<10;i++){
            CommunityBean communityBean=new CommunityBean();
            communityBean.setGoods_name("测试"+i);
            communityBean.setSelect(false);
    ...
    private void initRecyclerViewTow() {
        //创建adapter
        mCabinetListRecycleAdapter = new BatchOperationRightAdapter(this, CabinetEntityList);
        //给RecyclerView设置adapter
        ...
        mCabinetListRecycleAdapter.setOnChangeListener(new BatchOperationRightAdapter.OnChangeListener() {
            @Override
    ...
    private void TipsToast(String content,CommunityBean date, int type){
        new  XPopup.Builder(BatchOperationActivity.this)
