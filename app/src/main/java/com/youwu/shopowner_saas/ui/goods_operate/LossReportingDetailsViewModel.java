...
public class LossReportingDetailsViewModel extends BaseViewModel<DemoRepository> {

    //使用LiveData
    public SingleLiveEvent<Integer> IntegerEvent = new SingleLiveEvent<>();

    public LossReportingDetailsViewModel(@NonNull Application application, DemoRepository repository) {
     ...
     * @param saasList
     */
    public void add_Loss(String storeId, String saasList) {
        KLog.d("上传信息：storeId："+storeId,"remarks:"+remarks.get()+"saasList:"+saasList);
        model.ADD_LOSS_REPORT(storeId,remarks.get(),saasList)
