 ...
 * @author qdafengzi
 */
class RefundOrderDetailsAdapter(private val mContext: Context, private val mList: List<OrderBean.OrderRefundBean.RefundGoodsBean>?, private var mPosition: Int) : RecyclerView.Adapter<RefundOrderDetailsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.CommodityNum.text = "x"+mList!![position].goods_number
