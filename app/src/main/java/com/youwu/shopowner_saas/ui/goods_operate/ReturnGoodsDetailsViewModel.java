...
public class ReturnGoodsDetailsViewModel extends BaseViewModel<DemoRepository> {

    //使用LiveData
    public SingleLiveEvent<Integer> IntegerEvent = new SingleLiveEvent<>();

    public ReturnGoodsDetailsViewModel(@NonNull Application application, DemoRepository repository) {
