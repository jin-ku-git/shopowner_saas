...
public class GoodsSortViewModel extends BaseViewModel<DemoRepository> {
    ...
    public GoodsSortViewModel(@NonNull Application application, DemoRepository repository) {
