 ...
 * @author qdafengzi
 */
class OrderDetailsAdapter(private val mContext: Context, private val mList: List<OrderBean.OrderDetailsBean>?, private var mPosition: Int) : RecyclerView.Adapter<OrderDetailsAdapter.ViewHolder>() {
