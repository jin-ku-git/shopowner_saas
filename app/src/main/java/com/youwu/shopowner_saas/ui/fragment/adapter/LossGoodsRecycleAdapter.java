...
public class LossGoodsRecycleAdapter extends RecyclerView.Adapter<LossGoodsRecycleAdapter.myViewHodler> {
    private Context context;
    private List<ScrollBean.SAASOrderBean> goodsEntityList;
    private int currentIndex = 0;

    //创建构造函数
    public LossGoodsRecycleAdapter(Context context, List<ScrollBean.SAASOrderBean> goodsEntityList) {
        //将传递过来的数据，赋值给本地变量
    ...
    public myViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        //创建自定义布局
        View itemView = View.inflate(context, R.layout.item_loss_goods_layout, null);
